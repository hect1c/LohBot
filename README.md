...
The Discord.js bot for Legend of Heroes

## How To Use for Development

1. Clone the repo
2. Run `npm install` to get all the dependencies
3. Copy `config.example.js` to `config.js` and set bot token
4. Launch bot `node server/app.js` or `nodemon server/app.js`

## How To Deploy to Heroku (In progress)
